...
#ifndef __initial_concentration_h__
#define __initial_concentration_h__
...
class DiffCode::InitialConcentration: public LinearImplicitSystem, 
  public System::Assembly
{
 public: 
   ...
   * @return 
   */
  InitialConcentration(EquationSystems& eqSys, 
  ...
  void get_penalty_parameter(Number penalty);
 ...
 private: 
  ...
  std::map<boundary_id_type,Number> _simple_dbcs; 
